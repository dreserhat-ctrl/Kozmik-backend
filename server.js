...
async function analyze() {
  ...
  if(_hasKey) {
    ...
    try {
      ...
      var p1full = "KİŞİ 1: "+(k1sun||"Kova")+" güneş, "+(k1rising||"Oğlak")+" yükselen, Ay:"+cd1.moon+", Venüs:"+cd1.venus+", Mars:"+cd1.mars+", Merkür:"+cd1.mercury+", Jüpiter:"+cd1.jupiter+", Satürn:"+cd1.saturn+" | Natal açılar: "+natal1;
